...
function About() {
  ...
  echo <<<EOL
         ...
         \033[01;33mAuthor \033[01;37m:- \033[01;36mAruack
...
function upd() {
  ...
  sleep(1);
  system("cd ~/ && git clone https://github.com/Aruak/IPTracer.git");
  system("cd ~/ && sudo git clone https://github.com/Aruak/IPTracer.git");
